...
namespace App\Spatie\Permission\Traits;
...
trait HasPermissions
{
     ...
     */
    public function hasPermissionTo($permission, $guardName = 'admin'): bool
    {
     ...
     * @throws \Exception
     */
    public function hasAnyPermissionCustom($permissions,$guardName=NULL): bool
    {
        $permissions = collect($permissions)->flatten();

        foreach ($permissions as $permission) {
            if ($this->checkPermissionTo($permission,$guardName)) {
                return true;
            }
        }
